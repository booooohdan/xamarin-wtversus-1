    ...
    class ExpandableListViewAdapter : BaseExpandableListAdapter
    {
        ...
        public override View GetChildView(int groupPosition, int childPosition, bool isLastChild, View convertView, ViewGroup parent)
        {
            if (convertView == null)
            {
                ...
                convertView = inflater.Inflate(Resource.Layout._item_layout, null);
            }
        ...
        public override View GetGroupView(int groupPosition, bool isExpanded, View convertView, ViewGroup parent)
        {
            ...
            {
                LayoutInflater inflater = (LayoutInflater)context.GetSystemService(Context.LayoutInflaterService);
                convertView = inflater.Inflate(Resource.Layout._group_item, null);
            }
            string textGroup = (string)GetGroup(groupPosition);
            TextView textViewGroup = convertView.FindViewById<TextView>(Resource.Id.group);
            if (isExpanded)
                textViewGroup.SetTextColor(Android.Graphics.Color.Black);
            else
                textViewGroup.SetTextColor(Android.Graphics.Color.DarkGray);
